...
# Step to remove lines consisting of "digit : digit ."
# Regular expression to match patterns like "1:1." or "23:45."
    lines = [line for line in lines if not re.match(r"^\d+:\d+\.$", line.strip())]

# Step to remove number patterns at the end of a line, e.g., "Some text 23:45."
    lines = [re.sub(r'(\s*\d+:\d+\.\s*)$', '', line) for line in lines]
